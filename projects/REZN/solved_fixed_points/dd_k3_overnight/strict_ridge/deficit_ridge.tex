...
This appendix answers that. We re-solve the full
$\gamma\in\{1,10,30,100,300,1000\}\times\tau\in\{0.1,0.2,0.3,0.5,0.7,1.0\}$
$(6\times 6 = 36$ cells$)$ at $G=11$ under \emph{both} operators and
compare deficits on the same FPs.
...
\begin{figure}[h]
  ...
  \caption{Deficit vs $\tau$ for $\gamma \in \{1, 10, 30, 100, 300, 1000\}$. Under R4 (red)
...
\begin{enumerate}
  ...
  \item \textbf{Magnitude.}
        At all 36 completed cells the strict-$h{=}0$ deficit stays
