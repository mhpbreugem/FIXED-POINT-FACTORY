...
$\gamma\in\{1,10,30\}\times\tau\in\{0.1,0.2,0.3,0.5,0.7,1.0\}$ (18 cells)
at G=11 under \emph{both} operators and compare deficits on the same FPs.
The higher $\gamma$ rows (100, 300, 1000) were started but the
strict-$h{=}0$ Anderson stalls at the 30-cell time budget; for those
values we keep the existing 8 strict FPs from the main study as
spot-checks.
...
\begin{figure}[h]
  ...
  \caption{Deficit vs $\tau$ for $\gamma \in \{1, 10, 30\}$. Under R4 (red)
...
\begin{enumerate}
  ...
  \item \textbf{Magnitude.}
        At all 18 completed cells the strict-$h{=}0$ deficit stays
