...
$\gamma$ & slope $T$ & deficit & $d_{FR}$ & $\|F\|_\infty$ \\
\midrule
0.01 & 0.6070 & 0.1718 & 0.1326 & 5.57e-02 \\
0.05 & 0.6360 & 0.1425 & 0.1138 & 4.84e-02 \\
0.1 & 0.6636 & 0.1180 & 0.0941 & 3.76e-02 \\
0.3 & 0.7412 & 0.0823 & 0.0625 & 4.16e-02 \\
\bottomrule
\end{tabular}
\caption{CDF-cube $\gamma$-sweep at $G=13$, $NQ=64$.}
\end{table}
